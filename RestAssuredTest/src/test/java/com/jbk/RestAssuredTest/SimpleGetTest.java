...
public class SimpleGetTest {
	...
	public void VerifyTemperature() {
		...
		System.out.println("City received from Response " + Temperature);
		Assert.assertEquals(Temperature, "28.42 Degree celsius", "Correct city name received in the Response");
	}
